...
[FFFFFF]└ TG : [00FF00]@anyproblem_90
...
[FF00FF] ❀️TG NAME :
[FFFF00] ㅤ@anyproblem_90

[FFFFFF]❀️ Fᴏʟʟᴏᴡ ᴀɴᴅ Sᴜᴘᴘᴏʀᴛ: 
[00FFFF] ㅤ@anyproblem_90
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4669399465,password=GUEST_FF_CR3Y4_BY_STAR_GMR_E2D6C_S8ZXL_BY_SPIDEERIO_GAMING_MM8ZS")
        return None
